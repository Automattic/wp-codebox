...
### Added
- add a generic responsive layout sweep browser command

## [0.27.3] - 2026-09-25

### Fixed
- normalize changed-test-file path comparison to the discovery base

## [0.27.2] - 2026-09-24

### Fixed
- bump bundled mdi-native MDI archive to 49ec937
- cook wp-codebox
...
### Added
- add extra_themes remote/local theme sourcing

### Fixed
- grant id-token so the shared release workflow can start
- name the trapped PHP function in php.wasm rejection errors
- scope file-only testsuites to declared files

## [0.26.12] - 2026-09-20

### Fixed
- describe Codebox as a disposable WordPress site, not a nested agent runner
- condense the always-on WP Codebox AGENTS.md section
- repair site_admins after enabling multisite

## [0.26.11] - 2026-09-12

### Fixed
- Fix editor canvas probe authentication
...
### Added
- register a wp-codebox AGENTS.md section on the Agents API context registry
- capture external HTTP load evidence

### Changed
- Support portable editor canvas targets
- Retain complete PHPUnit failure artifacts
- Allow explicit native MDI sources
- wordpress.phpunit: add mdi-native backend
- isolate release lab environment assumptions
- Export the browser actions runner from the package entrypoint
- Capture browser session video as a named artifact
- classify artifact references in one place
- execute recipes through a typed boundary
- split smoke ownership lanes

### Fixed
- pin PHP 8.4 overlay with extension ABI exports
- classify runtime input materialization crashes
- emit recipe-run envelope for schema rejections
- preinstall native multisite PHPUnit state
- Fix bounded CLI error JSON serialization
- bound startup readiness
- collect resolved editor presentation assets
- complete browser lane ownership
- assign hidden Chromium consumers
- preserve large typed artifacts
- preserve typed artifact identity
- export recipe workload results
- persist collected workload results

## [0.26.8] - 2026-09-02

### Changed
- centralize process marker publication
...
### Fixed
- bootstrap editor screen class

## [0.26.6] - 2026-09-01

### Fixed
- synchronize bounded plan concurrency proof
- isolate parallel tsx transforms
- publish process markers atomically
- expect external editor presentation identities

## [0.26.5] - 2026-09-01

### Changed
- tolerate prefixed npm output
- preserve Cloudflare version independence

### Fixed
- recognize external editor presentation identities
- format atomic exchange helper safely
- harden promotion recovery
- make core promotion transactional
- close core promotion races
- harden derived core promotion
- exchange derived core atomically
- atomically promote core derivation
- keep packed commands package-local
- isolate Cloudflare boundary checks
- pin core derivation environment
- derive vendored core contracts
- install pinned Wrangler in production
- own Cloudflare package tests
- harden isolated Cloudflare package
- isolate Cloudflare package lane

## [0.26.4] - 2026-08-31

### Fixed
- separate presentation comparison thresholds
- reuse configured PHP workloads

## [0.26.3] - 2026-08-31

### Changed
- synchronize MariaDB abort coverage

### Fixed
- stabilize release evidence timing
- serialize fanout lifecycle events
...
### Fixed
- complete expected presentation capture
- wait for resolved editor post

## [0.26.1] - 2026-08-30

### Changed
- stabilize adaptive exploration coverage

### Fixed
- capture presentation with pending styles
