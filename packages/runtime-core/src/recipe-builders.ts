import type { RuntimePreviewSpec, RuntimeWordPressDatabaseSetup, RuntimeWordPressInstallMode, WorkspaceRecipe, WorkspaceRecipeExtraPlugin, WorkspaceRecipeMount, WorkspaceRecipePHPWasmExtensionManifest, WorkspaceRecipeRuntimeBackendPackage, WorkspaceRecipeRuntimeService, WorkspaceRecipeStep } from "./runtime-contracts.js"
...
export function buildWordPressPhpunitRecipe(options: WordPressPhpunitRecipeOptions): WorkspaceRecipe {
  ...
  return {
    ...
    runtime: {
      ...
      ...(options.databaseSetup ? { databaseSetup: options.databaseSetup } : {}),
