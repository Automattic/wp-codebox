...
export const commandRegistry = [
  ...
  },
  {
    ...
    acceptedArgs: [
      ...
      { name: "matrix-json", description: "Optional comparison matrix object with comparisons and optional viewports arrays; each comparison may provide source/candidate targets, labels, viewport, reduced-motion/reducedMotion, animations, frozen-time/frozenTime, capture-style/captureStyle, block-external-requests/blockExternalRequests, maxExplanationElements/maxExplanationCandidates/explainSelectors, or kebab-case explanation aliases.", format: "JSON object" },
