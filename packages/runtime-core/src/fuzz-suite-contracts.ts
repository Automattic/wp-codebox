...
export const RUNTIME_BACKED_FUZZ_SUITE_RUNNER_CAPABILITIES: FuzzSuiteRunnerCapabilities = {
  ...
  commands: ["wp-codebox.checkpoint-create", "wp-codebox.checkpoint-list", "wp-codebox.checkpoint-restore", "wordpress.ability", "wordpress.browser-actions", "wordpress.browser-page-load", "wordpress.browser-probe", "wordpress.collect-workload-result", "wordpress.crud-operation", "wordpress.db-operation", "wordpress.editor-open", "wordpress.execution-surfaces", "wordpress.fuzz-admin-pages", "wordpress.fuzz-plugin-module-state", "wordpress.http-request", "wordpress.inventory-plugin-module-options-tables", "wordpress.invoke-cron-event", "wordpress.invoke-hook", "wordpress.invoke-wp-cli", "wordpress.rest-performance-observation", "wordpress.rest-request", "wordpress.run-php", "wordpress.run-workload", "wordpress.server-page-load", "wordpress.simulated-admin-page-load", "wordpress.simulated-frontend-page-load", "wordpress.wp-cli"],
  unsupportedRequiredCapabilities: [],
}
...
export const WORDPRESS_FUZZ_RUNTIME_CONTRACT: WordPressFuzzRuntimeContract = {
  ...
  actionFamilies: [
    ...
    },
    {
      ...
      commands: ["wordpress.collect-workload-result", "wordpress.crud-operation", "wordpress.db-operation", "wordpress.execution-surfaces", "wordpress.inventory-plugin-module-options-tables", "wordpress.invoke-cron-event", "wordpress.invoke-hook", "wordpress.invoke-wp-cli", "wordpress.rest-performance-observation", "wordpress.rest-request", "wordpress.run-php", "wordpress.run-workload", "wordpress.wp-cli"],
