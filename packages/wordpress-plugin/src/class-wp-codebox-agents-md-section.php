...
final class WP_Codebox_Agents_Md_Section {
	...
	public static function render(): string {
		...
		$lines = array(
			...
			'',
			'**Safety**',
			'- `artifacts apply` writes through the host apply-back adapter. Review `inspect` output and pass `--approved-files`.',
			'- Credentials travel as `secret_env` names.',
			'',
			'**Discovery**',
