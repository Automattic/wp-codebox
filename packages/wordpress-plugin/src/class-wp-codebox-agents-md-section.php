...
final class WP_Codebox_Agents_Md_Section {
	...
	public static function render(): string {
		...
		$lines = array(
			'## WP Codebox',
			'',
			'Disposable, isolated WordPress sites. Blow them up freely: workloads, tests, and fuzz run here so the host install stays intact. Results return as artifact bundles for host review and apply-back. Abilities: `wp-codebox/*`. CLI mirrors the same service layer.',
			'',
			'**Default routing**',
