...
interface PlaygroundCommandRuntime {
  ...
  runBrowserExportReplayPackage(spec: ExecutionSpec): Promise<string>
...
const playgroundCommandHandlers = {
  ...
  "wordpress.browser-export-replay-package": (runtime, spec) => runtime.runBrowserExportReplayPackage(spec),
