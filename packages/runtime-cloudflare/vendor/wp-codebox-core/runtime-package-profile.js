...
function isSafeRelativePath(value) { return typeof value === "string" && Boolean(value) && value.length <= 2_048 && !value.startsWith("/") && !value.includes("\\") && /^[A-Za-z0-9._/-]+$/.test(value) && value.split("/").every((segment, index, segments) => (segment !== "" || index === segments.length - 1) && segment !== "." && segment !== "..") }
function isSafeFilePath(value) { return isSafeRelativePath(value) && !value.endsWith("/") }
