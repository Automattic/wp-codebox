...
- The runtime backend compatibility facade is for advanced runtime-backend
  implementors. Product consumers should use the Codebox-owned public surfaces
  above and the WordPress/browser surfaces below.
