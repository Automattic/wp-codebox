...
assert.ok(projectModeCode.includes("'cacheResult' => false"), "project bootstrap mode must disable PHPUnit result caching")
assert.ok(projectModeCode.includes("'cacheResultFile' => wp_codebox_phpunit_args_private_cache_result_file()"), "project bootstrap mode must use the sandbox-private PHPUnit result cache allocator")
