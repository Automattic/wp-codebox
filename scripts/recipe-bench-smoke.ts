...
assert.equal(scenario.samples.duration_ms.length, 2)
assert.equal(scenario.samples.metrics.fixture_value.length, 2)
assert.deepEqual(scenario.samples.metrics.fixture_value, [7, 7])
assert.equal(scenario.diagnostics.duration_ms.sample_count, 2)
assert.equal(scenario.diagnostics.metrics.fixture_value.sample_count, 2)
assert.equal(scenario.diagnostics.metrics.fixture_value.standard_deviation, 0)
...
assert.equal(configured.samples.duration_ms.length, 2)
assert.deepEqual(configured.samples.metrics.env_value, [13, 13])
assert.deepEqual(configured.samples.metrics.define_visible, [1, 1])
assert.equal(configured.diagnostics.duration_ms.sample_count, 2)
assert.equal(configured.diagnostics.metrics.env_value.sample_count, 2)
assert.equal(configured.diagnostics.metrics.env_value.standard_deviation, 0)
