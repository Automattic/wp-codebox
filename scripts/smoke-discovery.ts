...
export const DISCOVERY_EXCLUSIONS: readonly Exclusion[] = [
  ...
  { file: "tests/cloudflare-allocation-lifecycle.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-coordinator-site-partitioning.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-d1-operation-repository.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-d1-provisioner.test.mjs", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-phase-trace.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-principal-credential-operator.test.mjs", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-principal-credential-repository.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-provisioning-api.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-public-reader.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-queue-batch.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-remote-principal-credential-gate.test.mjs", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-runtime.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-site-context.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-wordpress-archive-corpus.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  { file: "tests/cloudflare-wordpress-auth.test.ts", reason: "owned by the independent runtime-cloudflare test lane" },
  {
